...
export const metadata: Metadata = {
  title: 'إدارة AI — المساعد الإداري الذكي التونسي',
  description:
  ...
  openGraph: {
    title: 'إدارة AI — المساعد الإداري الذكي بالدارجة التونسية',
    description: 'اسأله بالدارجة، يجاوبك بالقانون. جواز السفر، بطاقة التعريف، التنابر، المناظرات.',
    url: '/copilot',
  },
  alternates: {
    canonical: '/copilot',
