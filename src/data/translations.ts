...
export const translations: Record<SupportedLanguage, Record<string, string>> = {
  derja: {
    ...
    heroSubheadline: "Matdhaya3ch wa9tek fel صفوفات w l'awra9 el ne9sa. Es'el bel derja, faser awra9ek bel OCR, w a3mel les contrats wel procurations mte3ek mriglin w hadhrin lel Baladiya.",
    heroCTA: "🎙️ Jarreb el Voice Copilot",
    ...
    fasserliNav: "Fasserli Hal War9a",
    documentsNav: "Smart PDF Forms",
    calculatorNav: "Timbre & Awra9",
    locatorNav: "Guide des Baladiyas",
    launchpadNav: "Freelance Launchpad",
  ...
  fr: {
    ...
    heroHeadline: "Expliquez, Remplissez et Générez vos papiers en",
    heroHeadlineHighlight: "Quelques Secondes.",
    heroSubheadline: "Ne perdez plus 3 heures pour un timbre manquant ou une copie non certifiée. Posez vos questions en Derja ou Français, analysez vos courriers administratifs par OCR et générez vos contrats prêts pour la Baladiya.",
    heroCTA: "🎙️ Lancer le Voice Copilot",
    ...
    copilotNav: "Voice Copilot",
    fasserliNav: "Scanner & Décrypter",
    documentsNav: "Générateur PDF",
    calculatorNav: "Calculateur de Timbres",
    locatorNav: "Annuaire Municipal",
    launchpadNav: "Guide Freelance & RNE",
    proceduresNav: "Catalogue Démarches",
    ...
    regularHours: "Horaire Hiver (Double Séance)",
  ...
  ar: {
    ...
    heroHeadlineHighlight: "ثواني معدودة.",
    ...
    documentsNav: "استخراج الوثائق الرسمية",
    calculatorNav: "حاسبة التنابر والأوراق",
    locatorNav: "دليل البلديات والقباضات",
    launchpadNav: "فضاء الباعثين والمستقلين",
