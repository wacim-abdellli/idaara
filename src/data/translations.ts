...
export const translations: Record<SupportedLanguage, Record<string, string>> = {
  ...
  fr: {
    ...
    heroHeadline: "Réglez vos démarches en",
    heroHeadlineHighlight: "Quelques Secondes.",
    heroSubheadline: "Fini les files d'attente et les timbres manquants. Posez vos questions, analysez vos documents par OCR et obtenez vos dossiers prêts.",
  ...
  en: {
    ...
    heroHeadline: "Explain, Fill and Get your official papers in",
    heroHeadlineHighlight: "Seconds.",
    heroSubheadline: "Stop wasting time in government queues for a missing stamp. Ask in Derja or English, scan any official notice with OCR, and generate your legal forms for the Baladiya.",
