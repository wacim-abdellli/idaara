...
export const publicOfficesData: PublicOffice[] = [
  ...
  {
    id: 'cnss-kasserine', name: { derja: 'CNSS Kasserine', fr: 'CNSS Kasserine', ar: 'الصندوق الوطني للضمان الاجتماعي — القصرين' }, category: 'cnss', governorate: 'Kasserine', delegation: 'Kasserine Nord', address: 'Avenue Habib Bourguiba, 1200 Kasserine', phone: '+216 77 471 000', coordinates: { lat: 35.1676, lng: 8.8365 }, googleMapsUrl: 'https://maps.google.com/?q=35.1676,8.8365', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'cnss-sidi-bouzid', name: { derja: 'CNSS Sidi Bouzid', fr: 'CNSS Sidi Bouzid', ar: 'الصندوق الوطني للضمان الاجتماعي — سيدي بوزيد' }, category: 'cnss', governorate: 'Sidi Bouzid', delegation: 'Sidi Bouzid Ouest', address: 'Sidi Bouzid Centre', phone: '+216 76 630 000', coordinates: { lat: 35.0382, lng: 9.4849 }, googleMapsUrl: 'https://maps.google.com/?q=35.0382,9.4849', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'cnss-gabes', name: { derja: 'CNSS Gabès', fr: 'CNSS Gabès', ar: 'الصندوق الوطني للضمان الاجتماعي — قابس' }, category: 'cnss', governorate: 'Gabès', delegation: 'Gabès Médina', address: 'Avenue Habib Bourguiba, 6000 Gabès', phone: '+216 75 274 000', coordinates: { lat: 33.8881, lng: 10.0982 }, googleMapsUrl: 'https://maps.google.com/?q=33.8881,10.0982', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'cnss-medenine', name: { derja: 'CNSS Médenine', fr: 'CNSS Médenine', ar: 'الصندوق الوطني للضمان الاجتماعي — مدنين' }, category: 'cnss', governorate: 'Médenine', delegation: 'Médenine Nord', address: 'Avenue Habib Bourguiba, 4100 Médenine', phone: '+216 75 640 000', coordinates: { lat: 33.3547, lng: 10.5053 }, googleMapsUrl: 'https://maps.google.com/?q=33.3547,10.5053', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'cnss-tataouine', name: { derja: 'CNSS Tataouine', fr: 'CNSS Tataouine', ar: 'الصندوق الوطني للضمان الاجتماعي — تطاوين' }, category: 'cnss', governorate: 'Tataouine', delegation: 'Tataouine Nord', address: 'Tataouine Centre', phone: '+216 75 860 000', coordinates: { lat: 32.9211, lng: 10.4510 }, googleMapsUrl: 'https://maps.google.com/?q=32.9211,10.4510', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'cnss-gafsa', name: { derja: 'CNSS Gafsa', fr: 'CNSS Gafsa', ar: 'الصندوق الوطني للضمان الاجتماعي — قفصة' }, category: 'cnss', governorate: 'Gafsa', delegation: 'Gafsa Nord', address: 'Avenue Habib Bourguiba, 2100 Gafsa', phone: '+216 76 221 000', coordinates: { lat: 34.4250, lng: 8.7842 }, googleMapsUrl: 'https://maps.google.com/?q=34.4250,8.7842', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'cnss-tozeur', name: { derja: 'CNSS Tozeur', fr: 'CNSS Tozeur', ar: 'الصندوق الوطني للضمان الاجتماعي — توزر' }, category: 'cnss', governorate: 'Tozeur', delegation: 'Tozeur', address: 'Tozeur Centre', phone: '+216 76 452 000', coordinates: { lat: 33.9197, lng: 8.1335 }, googleMapsUrl: 'https://maps.google.com/?q=33.9197,8.1335', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'cnss-kebili', name: { derja: 'CNSS Kébili', fr: 'CNSS Kébili', ar: 'الصندوق الوطني للضمان الاجتماعي — قبلي' }, category: 'cnss', governorate: 'Kébili', delegation: 'Kébili Sud', address: 'Kébili Centre', phone: '+216 75 491 000', coordinates: { lat: 33.7042, lng: 8.9688 }, googleMapsUrl: 'https://maps.google.com/?q=33.7042,8.9688', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'cnss-zaghouan', name: { derja: 'CNSS Zaghouan', fr: 'CNSS Zaghouan', ar: 'الصندوق الوطني للضمان الاجتماعي — زغوان' }, category: 'cnss', governorate: 'Zaghouan', delegation: 'Zaghouan', address: 'Zaghouan Centre', phone: '+216 72 681 000', coordinates: { lat: 36.4028, lng: 10.1433 }, googleMapsUrl: 'https://maps.google.com/?q=36.4028,10.1433', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },

  // ================= POLICE / GARDE NATIONALE =================
  {
    id: 'commissariat-central-tunis', name: { derja: 'Commissariat Central Tunis (Bab Bhar)', fr: 'Commissariat Central de Tunis — Bab Bhar', ar: 'المفوضية العامة للأمن — تونس (باب البحر)' }, category: 'police_garde', governorate: 'Tunis', delegation: 'Bab El Bhar', address: 'Avenue Habib Bourguiba, Bab Bhar, 1000 Tunis', phone: '+216 71 254 530', coordinates: { lat: 36.7980, lng: 10.1780 }, googleMapsUrl: 'https://maps.google.com/?q=36.7980,10.1780', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24 — 7j/7' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24 — 7j/7' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24 — 7j/7' } }, tips: { derja: 'CIN w passeport: men 08:00 lel 16:00 faqat. Haja urgence: tout le temps.', fr: 'CIN et passeport: 08h00-16h00 uniquement. Urgences: 24h/24.', ar: 'بطاقة التعريف والجواز: من 08:00 إلى 16:00 فقط. الطوارئ: على مدار الساعة.' }
  },
  {
    id: 'commissariat-sfax', name: { derja: 'Commissariat de Police Sfax Ville', fr: 'Commissariat de Police — Sfax Ville', ar: 'مركز الشرطة — صفاقس المدينة' }, category: 'police_garde', governorate: 'Sfax', delegation: 'Sfax Médina', address: 'Avenue Ali Belhouane, 3000 Sfax', phone: '+216 74 299 000', coordinates: { lat: 34.7420, lng: 10.7620 }, googleMapsUrl: 'https://maps.google.com/?q=34.7420,10.7620', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }, tips: { derja: 'Dossier passeport men 08:00 lel 15:00. 7el warrak qbal.', fr: "Dossier passeport de 08h à 15h. Préparez votre dossier à l'avance.", ar: 'ملف جواز السفر من 08:00 إلى 15:00. أعد الملف مسبقاً.' }
  },
  {
    id: 'commissariat-sousse', name: { derja: 'Commissariat de Police Sousse', fr: 'Commissariat de Police — Sousse Ville', ar: 'مركز الشرطة — سوسة' }, category: 'police_garde', governorate: 'Sousse', delegation: 'Sousse Ville', address: 'Avenue Habib Bourguiba, 4000 Sousse', phone: '+216 73 226 777', coordinates: { lat: 35.8250, lng: 10.6340 }, googleMapsUrl: 'https://maps.google.com/?q=35.8250,10.6340', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'commissariat-nabeul', name: { derja: 'Commissariat de Police Nabeul', fr: 'Commissariat de Police — Nabeul', ar: 'مركز الشرطة — نابل' }, category: 'police_garde', governorate: 'Nabeul', delegation: 'Nabeul', address: 'Avenue Habib Thameur, 8000 Nabeul', phone: '+216 72 285 777', coordinates: { lat: 36.4560, lng: 10.7370 }, googleMapsUrl: 'https://maps.google.com/?q=36.4560,10.7370', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'commissariat-bizerte', name: { derja: 'Commissariat de Police Bizerte', fr: 'Commissariat de Police — Bizerte', ar: 'مركز الشرطة — بنزرت' }, category: 'police_garde', governorate: 'Bizerte', delegation: 'Bizerte Nord', address: 'Avenue Habib Bourguiba, 7000 Bizerte', phone: '+216 72 431 777', coordinates: { lat: 37.2740, lng: 9.8730 }, googleMapsUrl: 'https://maps.google.com/?q=37.2740,9.8730', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'garde-nationale-kasserine', name: { derja: 'Brigade Garde Nationale Kasserine', fr: 'Brigade de la Garde Nationale — Kasserine', ar: 'ثكنة الحرس الوطني — القصرين' }, category: 'police_garde', governorate: 'Kasserine', delegation: 'Kasserine Nord', address: 'Kasserine Centre', phone: '+216 77 470 300', coordinates: { lat: 35.1680, lng: 8.8360 }, googleMapsUrl: 'https://maps.google.com/?q=35.1680,8.8360', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'garde-nationale-gabes', name: { derja: 'Commissariat de Police Gabès', fr: 'Commissariat de Police — Gabès', ar: 'مركز الشرطة — قابس' }, category: 'police_garde', governorate: 'Gabès', delegation: 'Gabès Médina', address: 'Avenue Habib Bourguiba, 6000 Gabès', phone: '+216 75 272 477', coordinates: { lat: 33.8880, lng: 10.0980 }, googleMapsUrl: 'https://maps.google.com/?q=33.8880,10.0980', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'garde-nationale-tataouine', name: { derja: 'Brigade Garde Nationale Tataouine', fr: 'Brigade de la Garde Nationale — Tataouine', ar: 'ثكنة الحرس الوطني — تطاوين' }, category: 'police_garde', governorate: 'Tataouine', delegation: 'Tataouine Nord', address: 'Tataouine Centre', phone: '+216 75 860 100', coordinates: { lat: 32.9211, lng: 10.4510 }, googleMapsUrl: 'https://maps.google.com/?q=32.9211,10.4510', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'garde-nationale-kebili', name: { derja: 'Brigade Garde Nationale Kébili', fr: 'Brigade de la Garde Nationale — Kébili', ar: 'ثكنة الحرس الوطني — قبلي' }, category: 'police_garde', governorate: 'Kébili', delegation: 'Kébili Sud', address: 'Kébili Centre', phone: '+216 75 490 300', coordinates: { lat: 33.7042, lng: 8.9688 }, googleMapsUrl: 'https://maps.google.com/?q=33.7042,8.9688', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'garde-nationale-tozeur', name: { derja: 'Brigade Garde Nationale Tozeur', fr: 'Brigade de la Garde Nationale — Tozeur', ar: 'ثكنة الحرس الوطني — توزر' }, category: 'police_garde', governorate: 'Tozeur', delegation: 'Tozeur', address: 'Tozeur Centre', phone: '+216 76 452 300', coordinates: { lat: 33.9190, lng: 8.1340 }, googleMapsUrl: 'https://maps.google.com/?q=33.9190,8.1340', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'garde-nationale-sidi-bouzid', name: { derja: 'Brigade Garde Nationale Sidi Bouzid', fr: 'Brigade de la Garde Nationale — Sidi Bouzid', ar: 'ثكنة الحرس الوطني — سيدي بوزيد' }, category: 'police_garde', governorate: 'Sidi Bouzid', delegation: 'Sidi Bouzid Ouest', address: 'Sidi Bouzid Centre', phone: '+216 76 630 300', coordinates: { lat: 35.0380, lng: 9.4850 }, googleMapsUrl: 'https://maps.google.com/?q=35.0380,9.4850', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },

  // ================= ATTT =================
  {
    id: 'attt-tunis-siege', name: { derja: 'ATTT Siège Central (Cité Mahrajène)', fr: 'ATTT — Siège National, Cité Mahrajène', ar: 'الوكالة الفنية للنقل البري — المقر المركزي' }, category: 'attt', governorate: 'Tunis', delegation: 'El Omrane Supérieur', address: 'Rue 8601, Cité Mahrajène, 1082 Tunis', phone: '+216 71 780 064', coordinates: { lat: 36.8239, lng: 10.1722 }, googleMapsUrl: 'https://maps.google.com/?q=36.8239,10.1722', hasConformeService: false, hasTimbreVendor: false, website: 'https://attt.nat.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }, tips: { derja: '7adher contrat el bi3 el mouwatha9 w el carte grise el qadima. Khedmet tawil!', fr: 'Apportez le contrat de vente légalisé et l\'ancienne carte grise. Délais longs!', ar: 'أحضر عقد البيع الموثق والبطاقة الرمادية القديمة. الإجراءات تستغرق وقتاً.' }
  },
  {
    id: 'attt-sfax', name: { derja: 'ATTT Sfax', fr: 'ATTT — Agence de Sfax', ar: 'الوكالة الفنية للنقل البري — صفاقس' }, category: 'attt', governorate: 'Sfax', delegation: 'Sfax Ville', address: 'Route de Gabès, 3000 Sfax', phone: '+216 74 242 200', coordinates: { lat: 34.7350, lng: 10.7650 }, googleMapsUrl: 'https://maps.google.com/?q=34.7350,10.7650', hasConformeService: false, hasTimbreVendor: false, website: 'https://attt.nat.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'attt-sousse', name: { derja: 'ATTT Sousse', fr: 'ATTT — Agence de Sousse', ar: 'الوكالة الفنية للنقل البري — سوسة' }, category: 'attt', governorate: 'Sousse', delegation: 'Sousse Ville', address: 'Avenue Habib Bourguiba, 4000 Sousse', phone: '+216 73 242 200', coordinates: { lat: 35.8280, lng: 10.6390 }, googleMapsUrl: 'https://maps.google.com/?q=35.8280,10.6390', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'attt-nabeul', name: { derja: 'ATTT Nabeul', fr: 'ATTT — Agence de Nabeul', ar: 'الوكالة الفنية للنقل البري — نابل' }, category: 'attt', governorate: 'Nabeul', delegation: 'Nabeul', address: 'Nabeul Centre', phone: '+216 72 286 200', coordinates: { lat: 36.4500, lng: 10.7400 }, googleMapsUrl: 'https://maps.google.com/?q=36.4500,10.7400', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'attt-bizerte', name: { derja: 'ATTT Bizerte', fr: 'ATTT — Agence de Bizerte', ar: 'الوكالة الفنية للنقل البري — بنزرت' }, category: 'attt', governorate: 'Bizerte', delegation: 'Bizerte Nord', address: 'Bizerte Centre', phone: '+216 72 432 200', coordinates: { lat: 37.2700, lng: 9.8700 }, googleMapsUrl: 'https://maps.google.com/?q=37.2700,9.8700', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'attt-gabes', name: { derja: 'ATTT Gabès', fr: 'ATTT — Agence de Gabès', ar: 'الوكالة الفنية للنقل البري — قابس' }, category: 'attt', governorate: 'Gabès', delegation: 'Gabès Médina', address: 'Route de Tunis, 6000 Gabès', phone: '+216 75 274 200', coordinates: { lat: 33.8900, lng: 10.1000 }, googleMapsUrl: 'https://maps.google.com/?q=33.8900,10.1000', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'attt-medenine', name: { derja: 'ATTT Médenine', fr: 'ATTT — Agence de Médenine', ar: 'الوكالة الفنية للنقل البري — مدنين' }, category: 'attt', governorate: 'Médenine', delegation: 'Médenine Nord', address: 'Médenine Centre', phone: '+216 75 642 200', coordinates: { lat: 33.3500, lng: 10.5100 }, googleMapsUrl: 'https://maps.google.com/?q=33.3500,10.5100', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'attt-gafsa', name: { derja: 'ATTT Gafsa', fr: 'ATTT — Agence de Gafsa', ar: 'الوكالة الفنية للنقل البري — قفصة' }, category: 'attt', governorate: 'Gafsa', delegation: 'Gafsa Nord', address: 'Gafsa Centre', phone: '+216 76 221 200', coordinates: { lat: 34.4300, lng: 8.7800 }, googleMapsUrl: 'https://maps.google.com/?q=34.4300,8.7800', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },

  // ================= HOSPITALS =================
  {
    id: 'hopital-charles-nicolle', name: { derja: 'Hôpital Charles Nicolle Tunis', fr: 'Hôpital Charles Nicolle — CHU Tunis', ar: 'المستشفى الجامعي شارل نيكول — تونس' }, category: 'hopital', governorate: 'Tunis', delegation: 'Bab Saadoun', address: 'Rue Djebel Lakhdar, Bab Saadoun, 1006 Tunis', phone: '+216 71 578 000', coordinates: { lat: 36.8144, lng: 10.1658 }, googleMapsUrl: 'https://maps.google.com/?q=36.8144,10.1658', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24 — Urgences' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24 — Urgences' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24 — Urgences' } }, tips: { derja: 'A7sen hôpital fi Tunis — consultations externes men 08:00 lel 16:00.', fr: 'Meilleur hôpital de Tunis — consultations externes 08h-16h. Urgences 24h/24.', ar: 'أفضل مستشفى في تونس — العيادات الخارجية من 08:00 إلى 16:00. الطوارئ على مدار الساعة.' }
  },
  {
    id: 'hopital-la-rabta', name: { derja: 'Hôpital La Rabta Tunis', fr: 'Hôpital La Rabta — CHU Tunis', ar: 'مستشفى الرابطة — تونس' }, category: 'hopital', governorate: 'Tunis', delegation: 'Bab Saadoun', address: 'Jabbari, 1007 Tunis', phone: '+216 71 578 200', coordinates: { lat: 36.8308, lng: 10.1644 }, googleMapsUrl: 'https://maps.google.com/?q=36.8308,10.1644', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
  ...
  {
    id: 'baladiya-kairouan', name: { derja: 'Baladiyat Kairouan', fr: 'Municipalité de Kairouan', ar: 'بلدية القيروان' }, category: 'baladiya', governorate: 'Kairouan', delegation: 'Kairouan Nord', address: 'Avenue de la République, 3100 Kairouan', phone: '+216 77 231 222', coordinates: { lat: 35.6772, lng: 10.0978 }, googleMapsUrl: 'https://maps.google.com/?q=35.6772,10.0978', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
