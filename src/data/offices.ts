...
export const publicOfficesData: PublicOffice[] = [
  ...
  {
    id: 'hopital-sahloul', name: { derja: 'Hôpital Sahloul Sousse', fr: 'Hôpital Sahloul — CHU Sousse', ar: 'مستشفى سهلول — سوسة', en: 'Sahloul University Hospital — Sousse' }, category: 'hopital', governorate: 'Sousse', delegation: 'Hammam Sousse', address: 'Route de la Ceinture, Sahloul, 4054 Sousse', phone: '+216 73 362 244', coordinates: { lat: 35.8612, lng: 10.5929 }, googleMapsUrl: 'https://maps.google.com/?q=35.8612,10.5929', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }, tips: { derja: 'Meilleur hôpital fil jneb. SAMU: 73 362 244.', fr: 'Principal CHU du centre. Urgences excellentes.', ar: 'أكبر مستشفى في وسط البلاد.', en: 'Main university hospital of central Tunisia. Excellent emergency care.' }
  },
  {
    id: 'hopital-hedi-chaker', name: { derja: 'Hôpital Hédi Chaker Sfax', fr: 'Hôpital Hédi Chaker — CHU Sfax', ar: 'مستشفى الهادي شاكر — صفاقس', en: 'Hédi Chaker University Hospital — Sfax' }, category: 'hopital', governorate: 'Sfax', delegation: 'Sfax Ville', address: 'Avenue de la Cité Olympique, 3029 Sfax', phone: '+216 74 241 833', coordinates: { lat: 34.7280, lng: 10.7610 }, googleMapsUrl: 'https://maps.google.com/?q=34.7280,10.7610', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'hopital-fattouma-bourguiba', name: { derja: 'Hôpital Fattouma Bourguiba Monastir', fr: 'Hôpital Universitaire Fattouma Bourguiba — Monastir', ar: 'مستشفى فاطمة بورقيبة الجامعي — المنستير', en: 'Fattouma Bourguiba University Hospital — Monastir' }, category: 'hopital', governorate: 'Monastir', delegation: 'Monastir', address: 'Avenue Farhat Hached, 5000 Monastir', phone: '+216 73 460 000', coordinates: { lat: 35.7720, lng: 10.7930 }, googleMapsUrl: 'https://maps.google.com/?q=35.7720,10.7930', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'chr-gabes', name: { derja: 'CHR Gabès', fr: 'Centre Hospitalier Régional de Gabès', ar: 'المستشفى الجهوي — قابس', en: 'Regional Hospital Center (CHR) of Gabès' }, category: 'hopital', governorate: 'Gabès', delegation: 'Gabès Médina', address: 'Avenue Habib Thameur, 6000 Gabès', phone: '+216 75 270 130', coordinates: { lat: 33.9010, lng: 10.1080 }, googleMapsUrl: 'https://maps.google.com/?q=33.9010,10.1080', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'chr-medenine', name: { derja: 'CHR Médenine', fr: 'Centre Hospitalier Régional de Médenine', ar: 'المستشفى الجهوي — مدنين', en: 'Regional Hospital Center (CHR) of Médenine' }, category: 'hopital', governorate: 'Médenine', delegation: 'Médenine Nord', address: 'Médenine Centre', phone: '+216 75 640 100', coordinates: { lat: 33.3520, lng: 10.5010 }, googleMapsUrl: 'https://maps.google.com/?q=33.3520,10.5010', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'chr-kairouan', name: { derja: 'CHR Kairouan', fr: 'Centre Hospitalier Régional de Kairouan', ar: 'المستشفى الجهوي — القيروان', en: 'Regional Hospital Center (CHR) of Kairouan' }, category: 'hopital', governorate: 'Kairouan', delegation: 'Kairouan Nord', address: 'Route de Tunis, 3100 Kairouan', phone: '+216 77 231 400', coordinates: { lat: 35.6870, lng: 10.1060 }, googleMapsUrl: 'https://maps.google.com/?q=35.6870,10.1060', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },
  {
    id: 'chr-gafsa', name: { derja: 'CHR Gafsa', fr: 'Centre Hospitalier Régional de Gafsa', ar: 'المستشفى الجهوي — قفصة', en: 'Regional Hospital Center (CHR) of Gafsa' }, category: 'hopital', governorate: 'Gafsa', delegation: 'Gafsa Nord', address: 'Route de Sfax, 2100 Gafsa', phone: '+216 76 221 400', coordinates: { lat: 34.4190, lng: 8.7760 }, googleMapsUrl: 'https://maps.google.com/?q=34.4190,8.7760', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Dimanche', hours: '24h/24' }, ramadan: { days: 'Lundi - Dimanche', hours: '24h/24' }, summer: { days: 'Lundi - Dimanche', hours: '24h/24' } }
  },

  // ================= MISSING BALADIYAS =================
  {
    id: 'baladiya-ben-arous', name: { derja: 'Baladiyat Ben Arous', fr: 'Municipalité de Ben Arous', ar: 'بلدية بن عروس', en: 'Municipality of Ben Arous' }, category: 'baladiya', governorate: 'Ben Arous', delegation: 'Ben Arous', address: 'Avenue Habib Bourguiba, Ben Arous', phone: '+216 71 382 222', coordinates: { lat: 36.7533, lng: 10.2277 }, googleMapsUrl: 'https://maps.google.com/?q=36.7533,10.2277', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-manouba', name: { derja: 'Baladiyat Manouba', fr: 'Municipalité de Manouba', ar: 'بلدية منوبة', en: 'Municipality of Manouba' }, category: 'baladiya', governorate: 'Manouba', delegation: 'Manouba', address: 'Manouba Centre', phone: '+216 71 601 222', coordinates: { lat: 36.8081, lng: 10.0986 }, googleMapsUrl: 'https://maps.google.com/?q=36.8081,10.0986', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-beja', name: { derja: 'Baladiyat Béja', fr: 'Municipalité de Béja', ar: 'بلدية باجة', en: 'Municipality of Béja' }, category: 'baladiya', governorate: 'Béja', delegation: 'Béja Nord', address: 'Avenue Habib Bourguiba, 9000 Béja', phone: '+216 78 456 222', coordinates: { lat: 36.7256, lng: 9.1817 }, googleMapsUrl: 'https://maps.google.com/?q=36.7256,9.1817', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-jendouba', name: { derja: 'Baladiyat Jendouba', fr: 'Municipalité de Jendouba', ar: 'بلدية جندوبة', en: 'Municipality of Jendouba' }, category: 'baladiya', governorate: 'Jendouba', delegation: 'Jendouba Nord', address: 'Avenue Habib Bourguiba, 8100 Jendouba', phone: '+216 78 630 222', coordinates: { lat: 36.5011, lng: 8.7803 }, googleMapsUrl: 'https://maps.google.com/?q=36.5011,8.7803', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-kef', name: { derja: 'Baladiyat Le Kef', fr: 'Municipalité du Kef', ar: 'بلدية الكاف', en: 'Municipality of Le Kef' }, category: 'baladiya', governorate: 'Le Kef', delegation: 'Le Kef Ouest', address: 'Le Kef Centre', phone: '+216 78 221 222', coordinates: { lat: 36.1824, lng: 8.7148 }, googleMapsUrl: 'https://maps.google.com/?q=36.1824,8.7148', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-siliana', name: { derja: 'Baladiyat Siliana', fr: 'Municipalité de Siliana', ar: 'بلدية سليانة', en: 'Municipality of Siliana' }, category: 'baladiya', governorate: 'Siliana', delegation: 'Siliana Nord', address: 'Siliana Centre', phone: '+216 78 870 222', coordinates: { lat: 36.0843, lng: 9.3708 }, googleMapsUrl: 'https://maps.google.com/?q=36.0843,9.3708', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-mahdia', name: { derja: 'Baladiyat Mahdia', fr: 'Municipalité de Mahdia', ar: 'بلدية المهدية', en: 'Municipality of Mahdia' }, category: 'baladiya', governorate: 'Mahdia', delegation: 'Mahdia', address: 'Avenue Habib Bourguiba, 5100 Mahdia', phone: '+216 73 681 222', coordinates: { lat: 35.5047, lng: 11.0622 }, googleMapsUrl: 'https://maps.google.com/?q=35.5047,11.0622', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-kasserine', name: { derja: 'Baladiyat Kasserine', fr: 'Municipalité de Kasserine', ar: 'بلدية القصرين', en: 'Municipality of Kasserine' }, category: 'baladiya', governorate: 'Kasserine', delegation: 'Kasserine Nord', address: 'Avenue Habib Bourguiba, 1200 Kasserine', phone: '+216 77 471 222', coordinates: { lat: 35.1676, lng: 8.8365 }, googleMapsUrl: 'https://maps.google.com/?q=35.1676,8.8365', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-sidi-bouzid', name: { derja: 'Baladiyat Sidi Bouzid', fr: 'Municipalité de Sidi Bouzid', ar: 'بلدية سيدي بوزيد', en: 'Municipality of Sidi Bouzid' }, category: 'baladiya', governorate: 'Sidi Bouzid', delegation: 'Sidi Bouzid Ouest', address: 'Sidi Bouzid Centre', phone: '+216 76 630 222', coordinates: { lat: 35.0382, lng: 9.4849 }, googleMapsUrl: 'https://maps.google.com/?q=35.0382,9.4849', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-tataouine', name: { derja: 'Baladiyat Tataouine', fr: 'Municipalité de Tataouine', ar: 'بلدية تطاوين', en: 'Municipality of Tataouine' }, category: 'baladiya', governorate: 'Tataouine', delegation: 'Tataouine Nord', address: 'Tataouine Centre', phone: '+216 75 860 222', coordinates: { lat: 32.9211, lng: 10.4510 }, googleMapsUrl: 'https://maps.google.com/?q=32.9211,10.4510', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-gafsa', name: { derja: 'Baladiyat Gafsa', fr: 'Municipalité de Gafsa', ar: 'بلدية قفصة', en: 'Municipality of Gafsa' }, category: 'baladiya', governorate: 'Gafsa', delegation: 'Gafsa Nord', address: 'Avenue Habib Bourguiba, 2100 Gafsa', phone: '+216 76 221 222', coordinates: { lat: 34.4250, lng: 8.7842 }, googleMapsUrl: 'https://maps.google.com/?q=34.4250,8.7842', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-tozeur', name: { derja: 'Baladiyat Tozeur', fr: 'Municipalité de Tozeur', ar: 'بلدية توزر', en: 'Municipality of Tozeur' }, category: 'baladiya', governorate: 'Tozeur', delegation: 'Tozeur', address: 'Tozeur Centre', phone: '+216 76 452 222', coordinates: { lat: 33.9197, lng: 8.1335 }, googleMapsUrl: 'https://maps.google.com/?q=33.9197,8.1335', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-kebili', name: { derja: 'Baladiyat Kébili', fr: 'Municipalité de Kébili', ar: 'بلدية قبلي', en: 'Municipality of Kébili' }, category: 'baladiya', governorate: 'Kébili', delegation: 'Kébili Sud', address: 'Kébili Centre', phone: '+216 75 491 222', coordinates: { lat: 33.7042, lng: 8.9688 }, googleMapsUrl: 'https://maps.google.com/?q=33.7042,8.9688', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },
  {
    id: 'baladiya-zaghouan', name: { derja: 'Baladiyat Zaghouan', fr: 'Municipalité de Zaghouan', ar: 'بلدية زغوان', en: 'Municipality of Zaghouan' }, category: 'baladiya', governorate: 'Zaghouan', delegation: 'Zaghouan', address: 'Zaghouan Centre', phone: '+216 72 681 222', coordinates: { lat: 36.4028, lng: 10.1433 }, googleMapsUrl: 'https://maps.google.com/?q=36.4028,10.1433', hasConformeService: true, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 13:00 / 14:00 - 17:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:30' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 14:00' } }
  },

  // ================= STEG =================
  {
    id: 'steg-direction-generale', name: { derja: 'STEG Direction Générale (Bab Saadoun)', fr: 'STEG — Direction Générale, Bab Saadoun', ar: 'الشركة التونسية للكهرباء والغاز — المديرية العامة', en: 'STEG — General Directorate, Bab Saadoun' }, category: 'steg', governorate: 'Tunis', delegation: 'Bab Saadoun', address: 'Rue Taïeb Mhiri, Bab Saadoun, 1002 Tunis', phone: '+216 71 341 311', coordinates: { lat: 36.8200, lng: 10.1650 }, googleMapsUrl: 'https://maps.google.com/?q=36.8200,10.1650', hasConformeService: false, hasTimbreVendor: false, website: 'https://www.steg.com.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }, tips: { derja: 'Panne? Appelle: 71 341 000. Facture en ligne 3al site STEG.', fr: 'Signalement pannes: 71 341 000. Paiement factures en ligne sur steg.com.tn', ar: 'للإبلاغ عن أعطال: 71 341 000. دفع الفواتير عبر الإنترنت.', en: 'Report outages: 71 341 000. Pay bills online at steg.com.tn' }
  },
  {
    id: 'steg-sfax', name: { derja: 'STEG Sfax Régional', fr: 'STEG — Direction Régionale de Sfax', ar: 'STEG — المديرية الجهوية صفاقس', en: 'STEG — Sfax Regional Directorate' }, category: 'steg', governorate: 'Sfax', delegation: 'Sfax Ville', address: 'Route de Tunis, 3000 Sfax', phone: '+216 74 242 000', coordinates: { lat: 34.7380, lng: 10.7610 }, googleMapsUrl: 'https://maps.google.com/?q=34.7380,10.7610', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'steg-sousse', name: { derja: 'STEG Sousse', fr: 'STEG — Direction Régionale de Sousse', ar: 'STEG — المديرية الجهوية سوسة', en: 'STEG — Sousse Regional Directorate' }, category: 'steg', governorate: 'Sousse', delegation: 'Sousse Ville', address: 'Avenue Habib Bourguiba, 4000 Sousse', phone: '+216 73 226 000', coordinates: { lat: 35.8230, lng: 10.6370 }, googleMapsUrl: 'https://maps.google.com/?q=35.8230,10.6370', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'steg-bizerte', name: { derja: 'STEG Bizerte', fr: 'STEG — Direction Régionale de Bizerte', ar: 'STEG — المديرية الجهوية بنزرت', en: 'STEG — Bizerte Regional Directorate' }, category: 'steg', governorate: 'Bizerte', delegation: 'Bizerte Nord', address: 'Avenue Habib Bourguiba, 7000 Bizerte', phone: '+216 72 432 000', coordinates: { lat: 37.2720, lng: 9.8720 }, googleMapsUrl: 'https://maps.google.com/?q=37.2720,9.8720', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'steg-gabes', name: { derja: 'STEG Gabès', fr: 'STEG — Direction Régionale de Gabès', ar: 'STEG — المديرية الجهوية قابس', en: 'STEG — Gabès Regional Directorate' }, category: 'steg', governorate: 'Gabès', delegation: 'Gabès Médina', address: 'Avenue Farhat Hached, 6000 Gabès', phone: '+216 75 272 000', coordinates: { lat: 33.8870, lng: 10.0970 }, googleMapsUrl: 'https://maps.google.com/?q=33.8870,10.0970', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },

  // ================= SONEDE =================
  {
    id: 'sonede-direction-centrale', name: { derja: 'SONEDE Direction Centrale (Montplaisir)', fr: 'SONEDE — Direction Centrale, Cité Montplaisir', ar: 'الشركة الوطنية لاستغلال وتوزيع المياه — المديرية المركزية', en: 'SONEDE — Central Directorate, Cité Montplaisir' }, category: 'sonede', governorate: 'Tunis', delegation: 'El Menzah', address: 'Rue des Entrepreneurs, Cité Montplaisir, 1002 Tunis', phone: '+216 71 847 000', coordinates: { lat: 36.8157, lng: 10.1895 }, googleMapsUrl: 'https://maps.google.com/?q=36.8157,10.1895', hasConformeService: false, hasTimbreVendor: false, website: 'https://www.sonede.com.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }, tips: { derja: 'Fuite d\'eau? Appelle: 71 847 000 (urgences 24h/24). Facture 3la internet.', fr: 'Fuite urgence: 71 847 000 (24h/24). Paiement factures sur sonede.com.tn', ar: 'تسرب عاجل: 71 847 000 (على مدار الساعة). دفع الفواتير عبر الإنترنت.', en: 'Water leak emergency: 71 847 000 (24/7). Pay bills online at sonede.com.tn' }
  },
  {
    id: 'sonede-sfax', name: { derja: 'SONEDE Sfax', fr: 'SONEDE — Direction Régionale de Sfax', ar: 'SONEDE — المديرية الجهوية صفاقس', en: 'SONEDE — Sfax Regional Directorate' }, category: 'sonede', governorate: 'Sfax', delegation: 'Sfax Ville', address: 'Route de Tunis, 3000 Sfax', phone: '+216 74 241 000', coordinates: { lat: 34.7400, lng: 10.7600 }, googleMapsUrl: 'https://maps.google.com/?q=34.7400,10.7600', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'sonede-sousse', name: { derja: 'SONEDE Sousse', fr: 'SONEDE — Direction Régionale de Sousse', ar: 'SONEDE — المديرية الجهوية سوسة', en: 'SONEDE — Sousse Regional Directorate' }, category: 'sonede', governorate: 'Sousse', delegation: 'Sousse Ville', address: 'Avenue Léopold Senghor, 4000 Sousse', phone: '+216 73 226 500', coordinates: { lat: 35.8240, lng: 10.6360 }, googleMapsUrl: 'https://maps.google.com/?q=35.8240,10.6360', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },

  // ================= TRIBUNAUX =================
  {
    id: 'tribunal-tunis', name: { derja: 'Tribunal de Première Instance Tunis', fr: 'Tribunal de Première Instance de Tunis', ar: 'المحكمة الابتدائية — تونس', en: 'Court of First Instance of Tunis' }, category: 'tribunal', governorate: 'Tunis', delegation: 'Bab Bhar', address: 'Boulevard du 9 Avril 1938, 1002 Tunis', phone: '+216 71 334 000', coordinates: { lat: 36.8103, lng: 10.1700 }, googleMapsUrl: 'https://maps.google.com/?q=36.8103,10.1700', hasConformeService: false, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }, tips: { derja: 'Pour légalisation signature w casier judiciaire. 7adher CIN + timbre fiscal.', fr: 'Pour légalisation de signature et casier. CIN + timbre fiscal obligatoires.', ar: 'للتوثيق والسوابق العدلية. أحضر بطاقة التعريف والتنبر الجبائي.', en: 'For signature legalization and criminal record extracts. ID card + tax stamp required.' }
  },
  {
    id: 'tribunal-sfax', name: { derja: 'Tribunal de Première Instance Sfax', fr: 'Tribunal de Première Instance de Sfax', ar: 'المحكمة الابتدائية — صفاقس', en: 'Court of First Instance of Sfax' }, category: 'tribunal', governorate: 'Sfax', delegation: 'Sfax Médina', address: 'Rue Mongi Slim, 3000 Sfax', phone: '+216 74 296 000', coordinates: { lat: 34.7390, lng: 10.7600 }, googleMapsUrl: 'https://maps.google.com/?q=34.7390,10.7600', hasConformeService: false, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'tribunal-sousse', name: { derja: 'Tribunal de Première Instance Sousse', fr: 'Tribunal de Première Instance de Sousse', ar: 'المحكمة الابتدائية — سوسة', en: 'Court of First Instance of Sousse' }, category: 'tribunal', governorate: 'Sousse', delegation: 'Sousse Ville', address: 'Avenue Mohamed V, 4000 Sousse', phone: '+216 73 226 100', coordinates: { lat: 35.8260, lng: 10.6350 }, googleMapsUrl: 'https://maps.google.com/?q=35.8260,10.6350', hasConformeService: false, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'tribunal-nabeul', name: { derja: 'Tribunal de Première Instance Nabeul', fr: 'Tribunal de Première Instance de Nabeul', ar: 'المحكمة الابتدائية — نابل', en: 'Court of First Instance of Nabeul' }, category: 'tribunal', governorate: 'Nabeul', delegation: 'Nabeul', address: 'Avenue Habib Bourguiba, 8000 Nabeul', phone: '+216 72 285 100', coordinates: { lat: 36.4560, lng: 10.7370 }, googleMapsUrl: 'https://maps.google.com/?q=36.4560,10.7370', hasConformeService: false, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'tribunal-bizerte', name: { derja: 'Tribunal de Première Instance Bizerte', fr: 'Tribunal de Première Instance de Bizerte', ar: 'المحكمة الابتدائية — بنزرت', en: 'Court of First Instance of Bizerte' }, category: 'tribunal', governorate: 'Bizerte', delegation: 'Bizerte Nord', address: 'Avenue Habib Bourguiba, 7000 Bizerte', phone: '+216 72 431 100', coordinates: { lat: 37.2740, lng: 9.8730 }, googleMapsUrl: 'https://maps.google.com/?q=37.2740,9.8730', hasConformeService: false, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'tribunal-gabes', name: { derja: 'Tribunal de Première Instance Gabès', fr: 'Tribunal de Première Instance de Gabès', ar: 'المحكمة الابتدائية — قابس', en: 'Court of First Instance of Gabès' }, category: 'tribunal', governorate: 'Gabès', delegation: 'Gabès Médina', address: 'Avenue Farhat Hached, 6000 Gabès', phone: '+216 75 272 100', coordinates: { lat: 33.8870, lng: 10.0970 }, googleMapsUrl: 'https://maps.google.com/?q=33.8870,10.0970', hasConformeService: false, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'tribunal-kairouan', name: { derja: 'Tribunal de Première Instance Kairouan', fr: 'Tribunal de Première Instance de Kairouan', ar: 'المحكمة الابتدائية — القيروان', en: 'Court of First Instance of Kairouan' }, category: 'tribunal', governorate: 'Kairouan', delegation: 'Kairouan Nord', address: 'Avenue de la République, 3100 Kairouan', phone: '+216 77 231 100', coordinates: { lat: 35.6780, lng: 10.0960 }, googleMapsUrl: 'https://maps.google.com/?q=35.6780,10.0960', hasConformeService: false, hasTimbreVendor: true, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },

  // ================= ANETI =================
  {
    id: 'aneti-tunis-siege', name: { derja: 'ANETI Siège National (Tunis)', fr: 'ANETI — Siège National, Tunis', ar: 'الوكالة الوطنية للتشغيل والعمل المستقل — المقر المركزي', en: 'ANETI — National Headquarters, Tunis' }, category: 'aneti', governorate: 'Tunis', delegation: 'El Omrane', address: 'Avenue Louis Braille, Cité El Khadra, 1003 Tunis', phone: '+216 71 840 900', coordinates: { lat: 36.8191, lng: 10.1724 }, googleMapsUrl: 'https://maps.google.com/?q=36.8191,10.1724', hasConformeService: false, hasTimbreVendor: false, website: 'https://www.aneti.nat.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }, tips: { derja: 'Hna tasjel pal 5edma, SIVP, w AIDA. 7adher CIN w diplôme.', fr: 'Inscription chômage, SIVP et AIDA. Apportez CIN et diplôme.', ar: 'للتسجيل كطالب شغل والبرامج (SIVP, AIDA). أحضر بطاقة التعريف والشهادة.', en: 'Register for unemployment, SIVP and AIDA programs. Bring ID card and diploma.' }
  },
  {
    id: 'aneti-sfax', name: { derja: 'ANETI Sfax', fr: 'ANETI — Agence de Sfax', ar: 'وكالة التشغيل والعمل المستقل — صفاقس', en: 'ANETI — Sfax Branch' }, category: 'aneti', governorate: 'Sfax', delegation: 'Sfax Ville', address: 'Route de Tunis, Sfax', phone: '+216 74 240 900', coordinates: { lat: 34.7410, lng: 10.7590 }, googleMapsUrl: 'https://maps.google.com/?q=34.7410,10.7590', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'aneti-sousse', name: { derja: 'ANETI Sousse', fr: 'ANETI — Agence de Sousse', ar: 'وكالة التشغيل والعمل المستقل — سوسة', en: 'ANETI — Sousse Branch' }, category: 'aneti', governorate: 'Sousse', delegation: 'Sousse Ville', address: 'Avenue Habib Bourguiba, 4000 Sousse', phone: '+216 73 224 900', coordinates: { lat: 35.8250, lng: 10.6360 }, googleMapsUrl: 'https://maps.google.com/?q=35.8250,10.6360', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'aneti-gabes', name: { derja: 'ANETI Gabès', fr: 'ANETI — Agence de Gabès', ar: 'وكالة التشغيل والعمل المستقل — قابس', en: 'ANETI — Gabès Branch' }, category: 'aneti', governorate: 'Gabès', delegation: 'Gabès Médina', address: 'Avenue Habib Bourguiba, 6000 Gabès', phone: '+216 75 272 900', coordinates: { lat: 33.8880, lng: 10.0980 }, googleMapsUrl: 'https://maps.google.com/?q=33.8880,10.0980', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'aneti-kasserine', name: { derja: 'ANETI Kasserine', fr: 'ANETI — Agence de Kasserine', ar: 'وكالة التشغيل والعمل المستقل — القصرين', en: 'ANETI — Kasserine Branch' }, category: 'aneti', governorate: 'Kasserine', delegation: 'Kasserine Nord', address: 'Kasserine Centre', phone: '+216 77 470 900', coordinates: { lat: 35.1680, lng: 8.8360 }, googleMapsUrl: 'https://maps.google.com/?q=35.1680,8.8360', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'aneti-gafsa', name: { derja: 'ANETI Gafsa', fr: 'ANETI — Agence de Gafsa', ar: 'وكالة التشغيل والعمل المستقل — قفصة', en: 'ANETI — Gafsa Branch' }, category: 'aneti', governorate: 'Gafsa', delegation: 'Gafsa Nord', address: 'Gafsa Centre', phone: '+216 76 221 900', coordinates: { lat: 34.4250, lng: 8.7840 }, googleMapsUrl: 'https://maps.google.com/?q=34.4250,8.7840', hasConformeService: false, hasTimbreVendor: false, schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:00 - 16:00' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },

  // ================= MINISTÈRES (TUNIS) =================
  {
    id: 'ministere-interieur', name: { derja: "Ministère de l'Intérieur (El Kasbah)", fr: "Ministère de l'Intérieur — La Kasbah", ar: 'وزارة الداخلية — القصبة', en: 'Ministry of the Interior — La Kasbah' }, category: 'ministere', governorate: 'Tunis', delegation: 'Médina', address: 'Place de la Kasbah, 1008 Tunis', phone: '+216 71 333 000', coordinates: { lat: 36.7985, lng: 10.1667 }, googleMapsUrl: 'https://maps.google.com/?q=36.7985,10.1667', hasConformeService: false, hasTimbreVendor: false, website: 'https://www.interieur.gov.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'ministere-finances', name: { derja: "Ministère des Finances (El Kasbah)", fr: "Ministère des Finances — La Kasbah", ar: 'وزارة المالية — القصبة', en: 'Ministry of Finance — La Kasbah' }, category: 'ministere', governorate: 'Tunis', delegation: 'Médina', address: 'Place de la Kasbah, 1008 Tunis', phone: '+216 71 571 888', coordinates: { lat: 36.7990, lng: 10.1660 }, googleMapsUrl: 'https://maps.google.com/?q=36.7990,10.1660', hasConformeService: false, hasTimbreVendor: false, website: 'https://www.finances.gov.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'ministere-education', name: { derja: "Ministère de l'Éducation (Bab Bnet)", fr: "Ministère de l'Éducation Nationale — Bab Bnet", ar: 'وزارة التربية الوطنية — باب بنات', en: 'Ministry of National Education — Bab Bnet' }, category: 'ministere', governorate: 'Tunis', delegation: 'Médina', address: 'Rue Bab Bnet, 1030 Tunis', phone: '+216 71 786 300', coordinates: { lat: 36.8083, lng: 10.1711 }, googleMapsUrl: 'https://maps.google.com/?q=36.8083,10.1711', hasConformeService: false, hasTimbreVendor: false, website: 'https://www.education.gov.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'ministere-sante', name: { derja: "Ministère de la Santé (Bab Saadoun)", fr: "Ministère de la Santé — Bab Saadoun", ar: 'وزارة الصحة — باب سعدون', en: 'Ministry of Health — Bab Saadoun' }, category: 'ministere', governorate: 'Tunis', delegation: 'Bab Saadoun', address: 'Bab Saadoun, 1006 Tunis', phone: '+216 71 578 000', coordinates: { lat: 36.8210, lng: 10.1680 }, googleMapsUrl: 'https://maps.google.com/?q=36.8210,10.1680', hasConformeService: false, hasTimbreVendor: false, website: 'https://www.santetunisie.rns.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
  {
    id: 'ministere-justice', name: { derja: "Ministère de la Justice (Cité El Khadra)", fr: "Ministère de la Justice — Cité El Khadra", ar: 'وزارة العدل — المدينة الخضراء', en: 'Ministry of Justice — Cité El Khadra' }, category: 'ministere', governorate: 'Tunis', delegation: 'El Omrane Supérieur', address: 'Cité El Khadra, 1003 Tunis', phone: '+216 71 232 000', coordinates: { lat: 36.8330, lng: 10.1950 }, googleMapsUrl: 'https://maps.google.com/?q=36.8330,10.1950', hasConformeService: false, hasTimbreVendor: false, website: 'https://www.justice.gov.tn', schedule: { regular: { days: 'Lundi - Vendredi', hours: '08:30 - 16:30' }, ramadan: { days: 'Lundi - Vendredi', hours: '08:00 - 14:00' }, summer: { days: 'Lundi - Vendredi', hours: '07:30 - 13:30' } }
  },
];
