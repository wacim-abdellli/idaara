...
export const proceduresData: Procedure[] = [
  // ================= IDENTITY & CITIZENSHIP =================
  {
    ...
    shortDescription: {
      ...
      en: "Complete dossier, fiscal stamps and steps at the police station to renew your passport.",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 't-pass-1',
        label: { derja: "Timbre fiscal passeport (Adulte)", fr: "Timbre fiscal passeport (Tarif ordinaire)", ar: "تنبر جبائي لجواز السفر (التعريفة العادية)", en: "Passport fiscal stamp (standard rate)" },
        amountTND: 80.0,
        quantity: 1,
      ...
      {
        id: 't-pass-2',
        label: { derja: "4 Tsawer chamsiya (Fond blanc)", fr: "4 Photos d'identité officielles fond blanc", ar: "4 صور شمسية خلفية بيضاء", en: "4 official ID photos, white background" },
        amountTND: 6.0,
        quantity: 1,
        category: 'photo',
      }
    ...
    requiredDocuments: [
      {
        id: 'doc-pass-1',
        name: { derja: "Matloub ta3mir formulaire passeport", fr: "Formulaire officiel de demande de passeport", ar: "مطبوعة طلب الحصول على جواز سفر", en: "Official passport application form" },
        originalRequired: true,
        description: { derja: "Ta5ouha men markez el chorta walla t'impriméha men Idaara.tn", fr: "Disponible au poste de police ou générée via Idaara.tn", ar: "تُسحب من المركز أو تُحمّل من المنصة", en: "Available at the police station or generated via Idaara.tn" }
      },
      {
        id: 'doc-pass-2',
        name: { derja: "Copie conforme CIN + Original", fr: "Copie de la CIN + Originale", ar: "نسخة من بطاقة التعريف الوطنية مع الاستظهار بالأصل", en: "Copy of the CIN + original" },
        originalRequired: true,
        copiesConformes: 1,
      },
      {
        id: 'doc-pass-3',
        name: { derja: "El Passeport el 9dim", fr: "Ancien passeport à renouveler", ar: "جواز السفر القديم المُراد تجديده", en: "Old passport to be renewed" },
        originalRequired: true,
      },
      {
        id: 'doc-pass-4',
        name: { derja: "4 Tsawer chamsiya jdod", fr: "4 Photos d'identité récentes", ar: "4 صور شمسية حديثة العهد", en: "4 recent ID photos" },
        originalRequired: true,
      },
      {
        id: 'doc-pass-5',
        name: { derja: "Ch'hadet 7odhwr (Lel tlemtha wel etudiants)", fr: "Certificat de scolarité / Inscription", ar: "شهادة مدرسية أو جامعية للمتمتعين بالتعريفة المخفضة", en: "School or university enrollment certificate" },
        originalRequired: true,
      }
    ],
    steps: [
  ...
  },
  {
    ...
    shortDescription: {
      ...
      en: "How to obtain a first national ID card (CIN) or renew it after an address/profession change or loss.",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 'c-cin-1',
        label: { derja: "Timbre fiscal CIN (3 DT)", fr: "Timbre fiscal CIN (3 DT)", ar: "تنبر جبائي لبطاقة التعريف (3 د.ت)", en: "CIN fiscal stamp (3 DT)" },
        amountTND: 3.0,
        quantity: 1,
        category: 'timbre_fiscal',
      },
      {
        id: 'c-cin-2',
        label: { derja: "3 Tsawer format officiel CIN", fr: "3 Photos d'identité officielles", ar: "3 صور شمسية مطابقة للمواصفات", en: "3 official ID photos" },
        amountTND: 5.0,
        quantity: 1,
        category: 'photo',
      },
      {
        id: 'c-cin-3',
        label: { derja: "Madhmoun welada (Extrait)", fr: "Extrait de naissance récent", ar: "مضمون ولادة حديث العهد", en: "Recent birth extract" },
        amountTND: 2.0,
        quantity: 1,
        category: 'autre',
      }
    ...
    requiredDocuments: [
      {
        id: 'doc-cin-1',
        name: { derja: "Madhmoun welada ma yetfoutech 3 chhour", fr: "Extrait de naissance de moins de 3 mois", ar: "مضمون ولادة لا تتجاوز مدة استخراجه 3 أشهر", en: "Birth extract less than 3 months old" },
        originalRequired: true,
      },
      {
        id: 'doc-cin-2',
        name: { derja: "Ch'hadet I9ama (Certificat de résidence)", fr: "Certificat de résidence", ar: "شهادة إقامة مُسلّمة من مركز الأمن المختص", en: "Residence certificate" },
        originalRequired: true,
      },
      {
        id: 'doc-cin-3',
        name: { derja: "Ch'hadet 3amal (Attestation de travail)", fr: "Attestation de travail ou diplôme", ar: "شهادة عمل أو شهادة ترسيم جامعي لإثبات المهنة", en: "Work certificate or diploma" },
        originalRequired: true,
      },
      {
        id: 'doc-cin-4',
        name: { derja: "3 Tsawer chamsiya khalfiya baydha2", fr: "3 Photos d'identité récentes", ar: "3 صور شمسية حديثة بخلفية بيضاء", en: "3 recent ID photos" },
        originalRequired: true,
      }
    ],
    steps: [
  ...
  },
  {
    ...
    shortDescription: {
      ...
      en: "Obtain your criminal record extract (B3) online via b3.interieur.gov.tn or at the police station.",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 'c-b3-1',
        label: { derja: "Timbre fiscal B3", fr: "Timbre fiscal B3 (3 DT)", ar: "تنبر جبائي للبطاقة عدد 3 (3 د.ت)", en: "B3 fiscal stamp (3 DT)" },
        amountTND: 3.0,
        quantity: 1,
        category: 'timbre_fiscal',
      },
      {
        id: 'c-b3-2',
        label: { derja: "Frais d'envoi Rapide Poste (en ligne)", fr: "Frais de livraison postale sécurisée", ar: "معلوم الإرسال عبر البريد السريع", en: "Secure postal delivery fee" },
        amountTND: 4.5,
        quantity: 1,
    ...
    requiredDocuments: [
      {
        id: 'doc-b3-1',
        name: { derja: "Copie CIN", fr: "Copie de la CIN", ar: "نسخة من بطاقة التعريف الوطنية", en: "Copy of the CIN" },
        originalRequired: true,
      },
      {
        id: 'doc-b3-2',
        name: { derja: "Madhmoun welada", fr: "Extrait de naissance", ar: "مضمون ولادة حديث", en: "Birth extract" },
        originalRequired: true,
      }
    ],
    steps: [
  ...
  // ================= TRANSPORT & VEHICLES =================
  {
    ...
    shortDescription: {
      ...
      en: "Complete guide to transferring the carte grise to your name with the Land Transport Technical Agency (ATTT).",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 'cg-1',
        label: { derja: "Enregistrement Contrat fel Recette", fr: "Droits d'enregistrement du contrat de vente", ar: "معاليم تسجيل عقد البيع بالقباضة المالية", en: "Registration duties on the sale contract" },
        amountTND: 100.0,
        quantity: 1,
        category: 'timbre_fiscal',
      },
      {
        id: 'cg-2',
        label: { derja: "Frais Nouvelle Carte Grise ATTT", fr: "Frais d'émission de la nouvelle carte grise", ar: "معاليم إصدار البطاقة الرمادية الجديدة بالوكالة", en: "Issuance fee for the new carte grise" },
        amountTND: 40.0,
        quantity: 1,
        category: 'frais_dossier',
      },
      {
        id: 'cg-3',
        label: { derja: "Légalisation Contrat fel Baladiya", fr: "Légalisation de signatures (x2)", ar: "معلوم التعريف بالإمضاء للطرفين بالبلدية", en: "Signature legalization (x2)" },
        amountTND: 5.0,
        quantity: 1,
    ...
    requiredDocuments: [
      {
        id: 'doc-cg-1',
        name: { derja: "Contrat de vente m'sajjel fel Recette", fr: "Contrat de vente enregistré à la Recette", ar: "عقد بيع مسجل بالقباضة المالية (أصل + نسخة)", en: "Sale contract registered at the Treasury Office" },
        originalRequired: true,
      },
      {
        id: 'doc-cg-2',
        name: { derja: "El Carte Grise el 9dima m'sa77a7 fiha el beye3", fr: "Ancienne carte grise barrée et signée", ar: "البطاقة الرمادية السابقة وموقع عليها البائع", en: "Old carte grise crossed out and signed" },
        originalRequired: true,
      },
      {
        id: 'doc-cg-3',
        name: { derja: "Ch'hadet el Visite Technique sal7a", fr: "Certificat de visite technique en cours de validité", ar: "شهادة فحص فني سارية المفعول", en: "Valid technical inspection certificate" },
        originalRequired: true,
      },
      {
        id: 'doc-cg-4',
        name: { derja: "Copie CIN mte3 el Chari", fr: "Copie de la CIN de l'acquéreur", ar: "نسخة من بطاقة التعريف الوطنية للمشتري", en: "Copy of the buyer's CIN" },
        originalRequired: true,
        copiesConformes: 1,
      }
    ],
  ...
  },
  {
    ...
    shortDescription: {
      ...
      en: "Ten-yearly driver's license renewal or duplicate after loss or damage.",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 'p-1',
        label: { derja: "Frais renouvellement permis ATTT", fr: "Frais de fabrication du permis biométrique", ar: "معاليم إصدار رخصة السياقة بالوكالة", en: "Biometric license production fee" },
        amountTND: 25.0,
        quantity: 1,
        category: 'frais_dossier',
      },
      {
        id: 'p-2',
        label: { derja: "Ch'hadet tebba (Médecin conventionné)", fr: "Certificat médical d'aptitude", ar: "كشف طبي وشهادة سلامة القدرات البصرية", en: "Medical fitness certificate" },
        amountTND: 15.0,
        quantity: 1,
        category: 'autre',
      },
      {
        id: 'p-3',
        label: { derja: "2 Tsawer format permis", fr: "2 Photos d'identité", ar: "2 صور شمسية", en: "2 ID photos" },
        amountTND: 5.0,
        quantity: 1,
        category: 'photo',
      }
    ...
    requiredDocuments: [
      {
        id: 'doc-p-1',
        name: { derja: "Ch'hadet tebba (Certificat médical modèle officiel)", fr: "Certificat médical officiel d'aptitude à la conduite", ar: "شهادة طبية مطابقة للنموذج القانوني", en: "Official medical certificate of fitness to drive" },
        originalRequired: true,
      },
      {
        id: 'doc-p-2',
        name: { derja: "El Permis el 9dim", fr: "Ancien permis de conduire", ar: "رخصة السياقة المنتهية الصلوحية", en: "Old driver's license" },
        originalRequired: true,
      },
      {
        id: 'doc-p-3',
  ...
  // ================= BUSINESS & FREELANCE =================
  {
    ...
    shortDescription: {
      ...
      en: "Simplified tax and social scheme for independent workers: flat tax of 0.5% to 1%, online registration.",
    },
    fullDescription: {
    ...
    requiredDocuments: [
      {
        id: 'doc-ae-1',
        name: { derja: "Copie CIN", fr: "Copie de la CIN valide", ar: "نسخة من بطاقة التعريف الوطنية سارية المفعول", en: "Copy of a valid CIN" },
        originalRequired: true,
      },
      {
        id: 'doc-ae-2',
        name: { derja: "Ch'hadet i9ama walla justificatif domicile", fr: "Justificatif de domicile / Facture STEG", ar: "مؤيد لمقر النشاط أو الإقامة (فاتورة كهرباء/عقد)", en: "Proof of address / STEG bill" },
        originalRequired: true,
      },
      {
        id: 'doc-ae-3',
        name: { derja: "Diplôme walla attestation compétence (si métier qualifié)", fr: "Diplôme professionnel ou certificat de formation", ar: "شهادة كفاءة مهنية أو جامعية للأنشطة المنظمة", en: "Professional diploma or training certificate" },
  ...
  },
  {
    ...
    shortDescription: {
      ...
      en: "Complete company formation path: articles of association, capital deposit, business tax (patente) and RNE registration.",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 'rne-1',
        label: { derja: "Frais d'immatriculation RNE", fr: "Frais d'immatriculation au RNE", ar: "معاليم الترسيم بالسجل الوطني للمؤسسات", en: "RNE registration fee" },
        amountTND: 100.0,
        quantity: 1,
        category: 'frais_dossier',
      },
      {
        id: 'rne-2',
        label: { derja: "Enregistrement Statuts fel Recette", fr: "Enregistrement fiscal des statuts (Recette)", ar: "معاليم تسجيل العقد التأسيسي بالقباضة المالية", en: "Tax registration of the articles of association (Treasury Office)" },
        amountTND: 100.0,
        quantity: 1,
        category: 'timbre_fiscal',
      },
      {
        id: 'rne-3',
        label: { derja: "Légalisation Statuts fel Baladiya", fr: "Légalisation de 5 exemplaires des statuts", ar: "التعريف بإمضاء نسخ العقد التأسيسي بالبلدية", en: "Legalization of 5 copies of the articles of association" },
        amountTND: 20.0,
        quantity: 1,
        category: 'legalisation',
      }
    ...
    requiredDocuments: [
      {
        id: 'doc-rne-1',
        name: { derja: "Statuts mte3 el charika (5 exemplaires mou3arfin)", fr: "5 exemplaires originaux des Statuts légalisés", ar: "5 نظائر أصلية من القانون الأساسي معرف بإمضائها", en: "5 legalized original copies of the articles of association" },
        originalRequired: true,
      },
      {
        id: 'doc-rne-2',
        name: { derja: "Ch'hadet blocage capital mel banque", fr: "Attestation de blocage du capital bancaire", ar: "شهادة بنكية في تجميد رأس المال التأسيسي", en: "Bank certificate of blocked share capital" },
        originalRequired: true,
      },
      {
        id: 'doc-rne-3',
        name: { derja: "Contrat de domiciliation walla contrat kré siège", fr: "Contrat de bail ou convention de domiciliation enregistré", ar: "عقد تسويغ مقر الشركة أو اتفاقية توطين مسجلة", en: "Registered lease contract or domiciliation agreement" },
        originalRequired: true,
      }
    ],
    steps: [
  ...
  // ================= HOUSING & UTILITIES =================
  {
    ...
    shortDescription: {
      ...
      en: "Bilingual lease contract generator compliant with the Code of Obligations and Contracts.",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 'loc-1',
        label: { derja: "Légalisation de signature fel Baladiya (x2)", fr: "Légalisation des signatures à la mairie", ar: "معلوم التعريف بالإمضاء للطرفين بالبلدية", en: "Signature legalization at the town hall" },
        amountTND: 5.0,
        quantity: 1,
        category: 'legalisation',
      },
      {
        id: 'loc-2',
        label: { derja: "Enregistrement fel Recette des Finances (1% loyer annuel + timbres)", fr: "Enregistrement fiscal (Droit proportionnel 1%)", ar: "معلوم التسجيل الجبائي بالقباضة (1% من المعين السنوي)", en: "Tax registration (proportional duty of 1%)" },
        amountTND: 30.0,
        quantity: 1,
        category: 'timbre_fiscal',
      }
    ...
    requiredDocuments: [
      {
        id: 'doc-loc-1',
        name: { derja: "Contrat de bail fi 3 nsa5", fr: "3 exemplaires du contrat de bail signés", ar: "3 نظائر من عقد الكراء ممضاة من الطرفين", en: "3 signed copies of the lease contract" },
        originalRequired: true,
      },
      {
        id: 'doc-loc-2',
        name: { derja: "Copie CIN el Kéri wel Mektéri", fr: "Copies des CIN du bailleur et du locataire", ar: "نسخ من بطاقات التعريف للمسوغ والمكتري", en: "Copies of the landlord's and tenant's CINs" },
        originalRequired: true,
      }
    ],
    steps: [
  ...
  },
  {
    ...
    shortDescription: {
      ...
      en: "Steps to install and connect a new single-/three-phase electricity meter or natural gas supply.",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 'steg-1',
        label: { derja: "Devis de branchement & Frais de pose compteur", fr: "Frais d'étude et de pose du compteur standard", ar: "معاليم دراسة وتركيب العداد الفردي", en: "Standard meter survey and installation fee" },
        amountTND: 180.0,
        quantity: 1,
        category: 'frais_dossier',
      }
    ...
    requiredDocuments: [
      {
        id: 'doc-st-1',
        name: { derja: "Ch'hadet rabt mel Baladiya walla Rokhsat bina2", fr: "Certificat de raccordement municipal ou permis de bâtir", ar: "شهادة في الربط مسلمة من البلدية أو رخصة بناء", en: "Municipal connection certificate or building permit" },
        originalRequired: true,
      },
      {
        id: 'doc-st-2',
        name: { derja: "Ch'hadet melkiya walla 3a9d kré", fr: "Titre de propriété ou contrat de bail enregistré", ar: "شهادة ملكية أو عقد كراء مسجل", en: "Proof of ownership or registered lease contract" },
        originalRequired: true,
      },
      {
        id: 'doc-st-3',
        name: { derja: "Ch'hadet salou7iya mel instalatour (Attestation d'installation)", fr: "Attestation de conformité de l'installateur électricien", ar: "شهادة في سلامة الشبكة الداخلية من فني معتمد", en: "Electrician's installation conformity attestation" },
        originalRequired: true,
      }
    ],
    steps: [
  ...
  // ================= HEALTHCARE & SOCIAL =================
  {
    ...
    shortDescription: {
      ...
      en: "Filing care forms (private system / family doctor), tracking the annual cap and transfer times.",
    },
    fullDescription: {
    ...
    requiredDocuments: [
      {
        id: 'doc-cnam-1',
        name: { derja: "Bulletin de soins m3abbi w mcacheti", fr: "Bulletin de soins dûment rempli et cacheté", ar: "بطاقة استرجاع مصاريف علاج معمرة ومختومة من الطبيب والصيدلي", en: "Care form duly completed and stamped" },
        originalRequired: true,
      },
      {
        id: 'doc-cnam-2',
        name: { derja: "Ordonnance originale m3aha les vignettes", fr: "Ordonnance médicale originale avec vignettes", ar: "الوصفة الطبية الأصلية ملصق عليها طوابع الأدوية", en: "Original prescription with medicine vignettes" },
        originalRequired: true,
      }
    ],
    steps: [
  ...
  // ================= CUSTOMS & DIASPORA =================
  {
    ...
    shortDescription: {
      ...
      en: "Eligibility conditions, duty calculation and steps to import a vehicle under the FCR scheme.",
    },
    fullDescription: {
    ...
    costsBreakdown: [
      {
        id: 'fcr-1',
        label: { derja: "Frais de dossier douane", fr: "Frais de timbre et déclaration douanière", ar: "معاليم التصريح الديواني", en: "Customs declaration stamp fee" },
        amountTND: 50.0,
        quantity: 1,
        category: 'frais_dossier',
      }
    ...
    requiredDocuments: [
      {
        id: 'doc-fcr-1',
        name: { derja: "Passeport fiha les cachets d'entrée/sortie kol", fr: "Passeport avec l'ensemble des cachets douaniers", ar: "جواز السفر يتضمن كافة أختام الدخول والخروج", en: "Passport showing all entry/exit stamps" },
        originalRequired: true,
      },
      {
        id: 'doc-fcr-2',
        name: { derja: "Carte de séjour fel kharej", fr: "Titre de séjour étranger valide", ar: "بطاقة الإقامة الأجنبية سارية المفعول", en: "Valid foreign residence permit" },
        originalRequired: true,
      },
      {
        id: 'doc-fcr-3',
        name: { derja: "Carte grise mte3 el karhba fi esmek", fr: "Carte grise du véhicule au nom du demandeur", ar: "البطاقة الرمادية للسيارة باسم صاحب المطلب", en: "Vehicle carte grise in the applicant's name" },
        originalRequired: true,
      }
    ],
    steps: [
