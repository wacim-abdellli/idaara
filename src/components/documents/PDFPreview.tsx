...
export const PDFPreview: React.FC<PDFPreviewProps> = ({ template, formData }) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-3 rounded-2xl bg-zinc-900/60 border border-zinc-800/80">
        {/* Language Switcher Tabs */}
        <div className="flex items-center p-0.5 rounded-xl bg-zinc-950 border border-zinc-800/80 text-xs">
          <button
            type="button"
        ...
        <div className="flex items-center space-x-2 rtl:space-x-reverse">
          <button
            onClick={handlePrint}
            className="flex items-center space-x-1.5 rtl:space-x-reverse px-3 py-1.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-xs font-semibold transition-colors cursor-pointer border border-zinc-700/80"
          >
          ...
          <button
            ...
            className="flex items-center space-x-1.5 rtl:space-x-reverse px-3.5 py-1.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold text-xs shadow-md shadow-emerald-500/20 transition-all hover:scale-105 cursor-pointer disabled:opacity-50"
          >
      ...
      <div className="bg-zinc-950/40 p-3 sm:p-5 rounded-2xl border border-zinc-800/60 overflow-x-auto flex justify-center">
        <div
          id="official-doc-render"
          dir={isRtl ? 'rtl' : 'ltr'}
          className={`w-[210mm] min-h-[280mm] bg-white text-zinc-900 p-8 sm:p-10 shadow-xl flex flex-col justify-between relative rounded-sm ${
