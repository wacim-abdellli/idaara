  ...
  return (
    <div className="p-4 sm:p-5 rounded-2xl bg-zinc-900/90 border border-zinc-800 space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-zinc-800">
        <div>
          <h4 className="text-xs sm:text-sm font-bold text-white flex items-center space-x-2 rtl:space-x-reverse">
            <span>📦</span>
            <span>
              {locale === 'ar'
      ...
      <div className="p-4 rounded-xl bg-zinc-950/70 border border-zinc-800/80 space-y-3 text-xs font-mono">
