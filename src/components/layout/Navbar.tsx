        ...
        <div className="flex items-center justify-between h-14 gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <motion.button
              ...
              className="hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-zinc-900/80 hover:bg-zinc-800/80 border border-zinc-800 text-zinc-400 hover:text-zinc-200 text-xs transition-colors cursor-pointer shrink-0 shadow-sm"
              title={
